...
import com.example.cliff.myrestaurant.adapters.RestaurantListAdapter;
import com.example.cliff.myrestaurant.models.Restaurant;
import com.example.cliff.myrestaurant.services.YelpService;
    ...
    private void getRestaurants(String location) {
        ...
        yelpService.findRestaurants(location, new Callback() {
            ...
            public void onResponse(Call call, Response response) {
                ...
                Log.d("data", mRestaurants.toString());
